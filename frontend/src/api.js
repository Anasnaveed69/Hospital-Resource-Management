...
export const addEquipment = (data) => api.post('/add-equipment', data);
...
export const addStaffWithSalary = (data) => api.post('/add-staff', data);
export const addAlertReport = (data) => api.post('/add-alerts', data);
